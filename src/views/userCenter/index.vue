        ...
        <el-card>
            <div class="basic-info">
                ...
                <span v-if="userInfo.sip  === 'ON'">
                    ...
                    <el-button link type="primary" @click="onSwitchSip()" disabled>关闭</el-button>
                </span>
                <span v-else>
                    <el-text class="value">未开启</el-text>
                    <el-button link type="primary" @click="onSwitchSip()" disabled>开启</el-button>
                </span>
...
export default {
    ...
    data() {
        return {
            userInfo: {},
            cancelmsg: '如果您不再使用此账号，可以将其注销，账号注销后，数据会被删除且无法恢复。\
